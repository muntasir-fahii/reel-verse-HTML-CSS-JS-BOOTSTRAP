...
const moviesArr = [
  ...
  },
  {
    ...
    ticketPrice: 300,
    posterURL:
      "https://i.pinimg.com/736x/ce/dc/b7/cedcb7c362b12989d4a9785ac6ab35dd.jpg",
  },
  {
    title: "Shamshera",
    year: 2022,
  ...
  },
  {
    ...
    ticketPrice: 330,
    posterURL:
      "https://c8.alamy.com/zooms/9/7aee09e6f64c4daf93d0583d9312b053/pyyfw7.jpg",
  },
  {
    title: "Monstrous",
    year: 2022,
  ...
  },
  {
    ...
    ticketPrice: 380,
    posterURL:
      "https://i.pinimg.com/736x/c0/52/04/c0520468d3e0cd334345281bd461bbd0.jpg",
  },
  {
    title: "Watcher",
    year: 2022,
  ...
  for (let i = 0; i < moviesArr.length; i++) {
    ...
    movieElement.innerHTML = `
            ...
            <div class="card-body text-dark">
              ...
              <h5 class="text-danger fw-bold">${moviesArr[i].ticketPrice} BDT</h5>
    ...
    bookTickets[i].addEventListener("click", function () {
      ...
      for (let j = 0; j < moviesArr.length; j++) {
        if (i === j) {
          ...
          <h5><strong>Price:</strong> ${price} BDT</h5>
          <h5><strong>VAT:</strong> ${vat} BDT</h5>
          <h3><strong>Subtotal:</strong> ${subTotal} BDT</h3>
          <button class="fw-bold btn btn-danger mt-4 buy-now">Buy Now</button>
          `;
